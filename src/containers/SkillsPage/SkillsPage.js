...
function SkillsPage() {
  return (
    <div className="bg-dark">
      <div className="lg:px-32 lg:flex  bg-dark w-screen h-screen">
        <div className="lg:w-1/2 lg:mx-0 mx-12 lg:mt-64 mt-16">
        ...
        <div className="lg:w-2/3 w-screen lg:px-32 md:px-24 sm:px-16 px-12 mt-12 lg:mt-24 mb-12 flex flex-wrap justify-center">
          <img
